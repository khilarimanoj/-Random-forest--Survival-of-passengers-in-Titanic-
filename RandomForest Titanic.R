...
train <- read.csv("D:/Document/r studio file/titanic_train.csv")
test <- read.csv("D:/Document/r studio file/titanic_test.csv")
...
conf <-table(train$Survived,Prediction, dnn = c("Actual", "Predicted"))
conf
